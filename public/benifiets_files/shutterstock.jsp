...
"undefined"==typeof usi_company&&(window.usi_company={rulesets:{testing:function(e){return!e.testing||usi_cookies.get("usi_enable")},device:function(e){return!e.device||usi_commons.device===e.device},required_cookies:function(e){return!e.required_cookies||usi_cookies.value_exists.apply(null,e.required_cookies)},suppress_cookies:function(e){if(!e.suppress_cookies)return!0;for(var r=0;r<e.suppress_cookies.length;r++)if(usi_cookies.value_exists(e.suppress_cookies[r]))return!1;return!0},required_elements:function(e){if(!e.required_elements)return!0;try{for(var r=0;r<e.required_elements.length;r++)if(!document.querySelector(e.required_elements[r]))return!1;return!0}catch(t){return!1}},min_subtotal:function(e){var r=usi_cookies.get("usi_subtotal")?Number(usi_cookies.get("usi_subtotal").replace(/[^0-9.]/g,"")):0;return!e.min_subtotal||r>e.min_subtotal},max_subtotal:function(e){var r=usi_cookies.get("usi_subtotal")?Number(usi_cookies.get("usi_subtotal").replace(/[^0-9.]/g,"")):0;return!e.max_subtotal||r<e.max_subtotal},date_ranges:function(e){return e.date_ranges&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.date_ranges||e.date_ranges.some(function(e){return usi_date.is_between(e[0],e[1])})},is_after:function(e){return e.is_after&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.is_after||usi_date.is_after(e.is_after)},is_before:function(e){return e.is_before&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.is_before||usi_date.is_before(e.is_before)},page_visits:function(e){return!e.page_visits||Number(usi_cookies.get("usi_page_visits"))>=e.page_visits},countries:function(e){return e.countries&&!usi_app.country?usi_commons.log("usi_app.country is required"):!e.countries||-1!==e.countries.indexOf(usi_app.country)},traffic_source:function(e){return!e.traffic_source||""===usi_cookies.get("usi_traffic_source")&&"direct"===e.traffic_source.toLowerCase()||!!usi_cookies.get("usi_traffic_source").match(e.traffic_source)},pages:function(e){return!e.pages||!!location.href.toLowerCase().match(e.pages.join("|").toLowerCase())},logged_in:function(e){return!((!0===e.logged_in||!1===e.logged_out)&&"loggedin"===usi_cookies.get("usi_visitor"))},logged_out:function(e){return!((!0===e.logged_out||!1===e.logged_in)&&"loggedin"!==usi_cookies.get("usi_visitor"))},return_visitor:function(e){return void 0===usi_app.is_return_visitor&&(!0===e.return_visitor||!1===e.new_visitor)&&usi_commons.log_error("usi_app.is_return_visitor is required"),!((!0===e.return_visitor||!1===e.new_visitor)&&!usi_app.is_return_visitor)},new_visitor:function(e){return void 0===usi_app.is_return_visitor&&(!0===e.new_visitor||!1===e.return_visitor)&&usi_commons.log_error("usi_app.is_return_visitor is required"),!((!0===e.new_visitor||!1===e.return_visitor)&&usi_app.is_return_visitor)},return_customer:function(e){return!((!0===e.return_customer||!1===e.new_customer)&&!usi_cookies.get("usi_customer_purchased"))},new_customer:function(e){return!((!0===e.new_customer||!1===e.return_customer)&&usi_cookies.get("usi_customer_purchased"))}},test_load:function(e,r){return!1},load_campaigns:function(e,r){try{if(!e||!e.campaigns)return;function t(e,r){var t=0;!function i(){if(!(t>=e.length)){var n=e[t++];r(n,function(e){e||i()})}}()}function i(e,r,t){if(!e)return"";var i=e.match(/^{{\s*usi_app\.([\w.]+)\s*}}$/);if(i){var n=i[1].split(".");let o=usi_app;for(let s of n){if(null==o||"object"!=typeof o)return e;o=o[s]}return"function"==typeof o?o(t||r):o}return e.replace(/{{\s*usi_commons\.device\s*}}/,usi_commons.device).replace(/{{\s*usi_app\.([\w.]+)\s*}}/g,function(e,r){if(!r)return e;for(var i=r.split("."),n=usi_app,o=0;o<i.length;o++){if(null==n||"object"!=typeof n)return e;n=n[i[o]]}return null==n?e:"function"==typeof n?n(t):n})}function n(e,r){var t=Object.assign(e);for(var n in t)t.hasOwnProperty(n)&&"string"==typeof t[n]&&t[n].match(/{{\s*usi_app\.(\w+)\s*}}/)&&(t[n]=i(t[n],t,r));return t}function o(e,r){try{var t,o,s,u=[];for(var a in usi_company.rulesets)usi_company.rulesets.hasOwnProperty(a)&&((0,usi_company.rulesets[a])(e)||u.push(a));for(var c in usi_company.custom_rulesets)usi_company.custom_rulesets.hasOwnProperty(c)&&((0,usi_company.custom_rulesets[c])(e)||u.push(c));if(e._missing=u,u.length>0)return r(!1);var f=[];if(e.list){if(!usi_app.company_id)return usi_commons.log_error("usi_app.company_id is required");if(!e.list.ids)return usi_commons.log_error("campaign.list.ids is required");if(!e.list.label)return usi_commons.log_error("campaign.list.label is required");f.push(function(r){var t=n(e.list,e);usi_company.lookup_callback=function(i){try{e.list._found=i,t.type=t.type||"suppress";var n=0===i&&"suppress"===t.type||1===i&&"enable"===t.type;r(n)}catch(o){usi_commons.report_error(o)}};var o=usi_commons.domain+"/utility/lookup_suppressions.jsp?companyID="+usi_app.company_id+"&product="+(Array.isArray(t.ids)?t.ids.join(","):i(t.ids,e))+"&label="+t.label+"&match="+(t.match||"any")+"&callback=usi_company.lookup_callback";usi_commons.load_script(o)})}if(e.lift){if("undefined"==typeof usi_split_test)return usi_commons.log_error("usi_split_test is required");if(!e.lift.id)return usi_commons.log_error("campaign.lift.id is required");f.push(function(r){usi_split_test.instantiate_callback(e.lift.id,function(t){if(0===t)return r(!1);e.lift._group=t,r(!0)})})}"object"==typeof e.split&&f.push(function(r){var t,i=Object.keys(e.split),n=usi_commons.gup("usi_force_group");if(n)t=n;else if(e._group)t=e._group;else if(e.lift&&"boolean"==typeof e.lift.split&&e.lift.split&&e.lift._group)t=e.lift._group;else{for(var o=0,s={},u=0;u<i.length;u++){var a=i[u],c=e.split[a].percent;s[a]="number"==typeof c&&c>0?c:1,o+=s[a]}for(var f=Math.random()*o,l=0,p=0;p<i.length;p++){var d=i[p];if(l+=s[d],f<l){t=d;break}}t||(t=i[0])}var g=e.split[t];for(var m in g)g.hasOwnProperty(m)&&(e[m]=g[m]);e._group=t,r(!0)}),e.recommendations&&f.push(function(r){var t=n(e.recommendations,e);t.callback=function(){var t=e.name?e.name.replace("usi_app.",""):"product_rec",i=usi_commons.gup("usi_test")||(usi_app[t]&&usi_app[t].data&&usi_app[t].data.length?usi_app[t].data.length:0)>=(e.recommendations.min_rows||e.recommendations.rows||3);e.recommendations.filter_callback&&"function"==typeof usi_app[e.recommendations.filter_callback]&&usi_app[e.recommendations.filter_callback](e),r(i)},usi_commons.load_products(t)}),t=f,o=function(t){r(t,e)},s=0,function e(r){return r?s>=t.length?o(!0):void t[s++](e):o(!1)}(!0)}catch(l){usi_commons.report_error(l),r(!1)}}usi_company.custom_rulesets=r||[],e.campaigns.usi_load&&t(e.campaigns.usi_load,function(e,r){e._type="usi_load",o(e,function(e,t){t&&(t._active=e),t&&e?("string"==typeof t.before_load&&"function"==typeof usi_app[t.before_load]&&usi_app[t.before_load](t),usi_commons.load(t.hash,t.siteID,i(t.key,t),function(){void 0!==window["usi_"+t.siteID]&&(window["usi_"+t.siteID].company_json=n(t)),r(usi_company.test_load(e,t))})):r(e)})}),e.campaigns.view&&t(e.campaigns.view,function(e,r){"undefined"==typeof usi_force&&-1==location.href.indexOf("usi_force")&&(e.suppress_cookies=(e.suppress_cookies||[]).concat("usi_sale","usi_launched","usi_launched"+e.siteID)),e._type="view",o(e,function(e,t){t&&(t._active=e),t&&e&&("string"==typeof t.before_load&&"function"==typeof usi_app[t.before_load]&&usi_app[t.before_load](t),usi_commons.load_view(t.hash,t.siteID,i(t.key,t),function(){"undefined"!=typeof usi_js&&(usi_js.company_json=n(t))})),r(e)})}),e.campaigns.anon&&t(e.campaigns.anon,function(e,r){e._type="anon",o(e,function(e,t){t&&(t._active=e,usi_app.anon_data=n(t),e&&("string"==typeof t.before_load&&"function"==typeof usi_app[t.before_load]&&usi_app[t.before_load](t),usi_user_id.activate(t.siteID))),r(e)})}),e.campaigns.precapture&&t(e.campaigns.precapture,function(e,r){e._type="precapture",o(e,function(e,t){t&&(t._active=e,usi_app.precapture_data=n(t),e&&("string"==typeof t.before_load&&"function"==typeof usi_app[t.before_load]&&usi_app[t.before_load](t),usi_commons.load_precapture(t.hash,t.siteID))),r(e)})})}catch(s){usi_commons.report_error(s)}}});
